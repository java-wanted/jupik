...
{
    public static void init(float []data, float value)
    {
    ...
    protected static boolean _calc(float[] data, int i)
    {
        int l = 0x100;
        int j = 0;
    ...
    public static void calc(float []data) throws InterruptedException
    {
        if (!_calc(data, 0))
        {
    ...
    protected static class Runner implements Runnable
    {
        ...
        public Runner(Status status, float []data, int i)
        {
            this.status = status;
            this.data = data;
            this.i = i;
    ...
    public static void calc2(float []data) throws InterruptedException
    {
        int n = data.length;
        int h = data.length / 2;
