...
public class LinkedListTest
{
    ...
    void testPeek()
    {
        Integer elem = elems.peek();

        Assertions.assertSame(elems.get(0), elem);
    }
    ...
    void testPeekEmpty()
    {
        ...
        Assertions.assertNull(elems.peek());
    }
    ...
    void testPoll()
    {
        ...
        Integer second = elems.get(1);
        Integer elem = elems.poll();

        Assertions.assertEquals(size - 1, elems.size());
        Assertions.assertSame(first, elem);
        Assertions.assertSame(second, elems.get(0));
    }
    ...
    void testPollEmpty()
    {
        ...
        Assertions.assertThrows(
            IndexOutOfBoundsException.class, () -> elems.poll()
        );
    }
}
